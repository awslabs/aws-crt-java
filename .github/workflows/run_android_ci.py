...
build_file_location = current_working_directory + '/android/crt/build/outputs/aar/crt-debug.aar'
test_file_location = current_working_directory + '/android/crt/build/outputs/aar/crt-debug.aar'
