...
build_file_location = current_working_directory + '/android/testapp/build/outputs/apk/debug/testapp-debug.apk'
test_file_location = current_working_directory + '/android/testapp/build/outputs/apk/androidTest/debug/testapp-debug-androidTest.apk'
