...
public class ObjectAlreadyInActiveTierErrorException extends S3Exception {
    protected ObjectAlreadyInActiveTierErrorException(BuilderImpl builder) {
        super(builder);
    }
    ...
    public interface Builder extends S3Exception.Builder {
        ObjectAlreadyInActiveTierErrorException build();
    }
