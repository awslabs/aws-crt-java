...
public class DeletePublicAccessBlockRequest {
    ...
    private DeletePublicAccessBlockRequest() {
        this.bucket = null;
    ...
    static final class Builder {
        ...
        private Builder(DeletePublicAccessBlockRequest model) {
            bucket(model.bucket);
            expectedBucketOwner(model.expectedBucketOwner);
        }

        public DeletePublicAccessBlockRequest build() {
            return new com.amazonaws.s3.model.DeletePublicAccessBlockRequest(this);
        }
