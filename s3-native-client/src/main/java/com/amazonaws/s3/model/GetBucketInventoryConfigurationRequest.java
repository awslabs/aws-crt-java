...
public class GetBucketInventoryConfigurationRequest {
    ...
    private GetBucketInventoryConfigurationRequest(Builder builder) {
    ...
    static final class Builder {
        ...
        private Builder(GetBucketInventoryConfigurationRequest model) {
            bucket(model.bucket);
            id(model.id);
        ...
        public GetBucketInventoryConfigurationRequest build() {
            return new com.amazonaws.s3.model.GetBucketInventoryConfigurationRequest(this);
        }
