...
public class GetBucketRequestPaymentRequest {
    ...
    private GetBucketRequestPaymentRequest() {
        this.bucket = null;
    ...
    static final class Builder {
        ...
        private Builder(GetBucketRequestPaymentRequest model) {
            bucket(model.bucket);
            expectedBucketOwner(model.expectedBucketOwner);
        }

        public GetBucketRequestPaymentRequest build() {
            return new com.amazonaws.s3.model.GetBucketRequestPaymentRequest(this);
        }
