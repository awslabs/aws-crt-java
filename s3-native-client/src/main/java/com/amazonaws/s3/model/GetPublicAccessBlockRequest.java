...
public class GetPublicAccessBlockRequest {
    ...
    private GetPublicAccessBlockRequest() {
        this.bucket = null;
    ...
    static final class Builder {
        ...
        private Builder(GetPublicAccessBlockRequest model) {
            bucket(model.bucket);
            expectedBucketOwner(model.expectedBucketOwner);
        }

        public GetPublicAccessBlockRequest build() {
            return new com.amazonaws.s3.model.GetPublicAccessBlockRequest(this);
        }
