...
public class ListBucketAnalyticsConfigurationsRequest {
    ...
    private ListBucketAnalyticsConfigurationsRequest() {
        this.bucket = null;
        this.continuationToken = null;
        this.expectedBucketOwner = null;
    }

    private ListBucketAnalyticsConfigurationsRequest(Builder builder) {
    ...
    static final class Builder {
        ...
        private Builder(ListBucketAnalyticsConfigurationsRequest model) {
            bucket(model.bucket);
        ...
        public ListBucketAnalyticsConfigurationsRequest build() {
            return new com.amazonaws.s3.model.ListBucketAnalyticsConfigurationsRequest(this);
        }
