...
public class PutBucketIntelligentTieringConfigurationRequest {
    ...
    private PutBucketIntelligentTieringConfigurationRequest() {
        this.bucket = null;
        this.id = null;
        this.intelligentTieringConfiguration = null;
    }

    private PutBucketIntelligentTieringConfigurationRequest(Builder builder) {
    ...
    static final class Builder {
        ...
        private Builder(PutBucketIntelligentTieringConfigurationRequest model) {
            bucket(model.bucket);
            id(model.id);
        ...
        public PutBucketIntelligentTieringConfigurationRequest build() {
            return new com.amazonaws.s3.model.PutBucketIntelligentTieringConfigurationRequest(this);
        }
