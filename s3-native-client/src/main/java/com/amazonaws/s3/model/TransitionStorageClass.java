...
enum TransitionStorageClass {
    GLACIER("software.amazon.smithy.crt.codegen.Field@6ef9b000"),

    STANDARD_IA("software.amazon.smithy.crt.codegen.Field@6ef9b000"),

    ONEZONE_IA("software.amazon.smithy.crt.codegen.Field@6ef9b000"),

    INTELLIGENT_TIERING("software.amazon.smithy.crt.codegen.Field@6ef9b000"),

    DEEP_ARCHIVE("software.amazon.smithy.crt.codegen.Field@6ef9b000"),
