 ...
 */
public class CrtCredentialsProvider extends CrtResource implements CredentialsProvider {
    ...
    public CompletableFuture<Credentials> getCredentials() {
        ...
        try {
            crtCredentialsProviderGetCredentials(this, future, getNativeHandle());
        } catch (Exception e) {
    ...
    protected void releaseNativeHandle() {
        if (!isNull()) {
            crtCredentialsProviderDestroy(this, getNativeHandle());
        }
    }
     ...
     * native methods
     ******************************************************************************/
    private static native void crtCredentialsProviderDestroy(CrtCredentialsProvider thisObj, long nativeHandle);
    private static native void crtCredentialsProviderGetCredentials(CrtCredentialsProvider thisObj, CompletableFuture<Credentials> future, long nativeHandle);
}
