...
public class StaticCredentialsProvider extends CredentialsProvider {
    public class StaticCredentialsProviderBuilder {
        ...
        public CredentialsProvider build() {
            return new StaticCredentialsProvider(accessKeyId, secretAccessKey, sessionToken);
        }
    }

    private StaticCredentialsProvider(String accessKeyId, String secretAccessKey, String sessionToken) {
        super();
    ...
    private static native long staticCredentialsProviderNew(StaticCredentialsProvider thisObj, String accessKeyId, String secretAccessKey, String sessionToken);
}
