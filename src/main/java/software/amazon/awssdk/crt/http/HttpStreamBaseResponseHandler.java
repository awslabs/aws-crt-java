...
public interface HttpStreamBaseResponseHandler {
     ...
     *
     * @param stream    The HttpStreamBase object
     * @param blockType The type of the header block, corresponds to
     *                  {@link HttpHeaderBlock}
     */
     ...
     *
     * @param stream      The HttpStreamBase the body was delivered to
     * @param bodyBytesIn The HTTP Body Bytes received in the last IO Event.
     * @return The number of bytes to move the sliding window by. Repeatedly
