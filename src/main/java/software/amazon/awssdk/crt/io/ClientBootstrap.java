...
public final class ClientBootstrap extends CrtResource {
    ...
    public ClientBootstrap(EventLoopGroup elg, HostResolver hr) throws CrtRuntimeException {
        acquireNativeHandle(clientBootstrapNew(this, elg, hr), (x)->clientBootstrapDestroy(x));
    }

    /*******************************************************************************
     * native methods
     ******************************************************************************/
    private static native long clientBootstrapNew(ClientBootstrap bootstrap, EventLoopGroup elg, HostResolver hr) throws CrtRuntimeException;
