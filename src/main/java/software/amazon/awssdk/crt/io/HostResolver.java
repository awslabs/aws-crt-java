 ...
 */
public class HostResolver extends CleanableCrtResource {
    ...
    public HostResolver(EventLoopGroup elg, int maxEntries) throws CrtRuntimeException {
        acquireNativeHandle(hostResolverNew(elg.getNativeHandle(), maxEntries), HostResolver::hostResolverRelease);
    }
