...
public enum QoS {
     ...
     * returned to the sender. The message will be stored in case it has to be re-sent. This is the most common QoS.
     */
    AT_LEAST_ONCE(1),

    /**
     * The message is always delivered exactly once. This is the safest, but slowest QoS, because multiple levels
