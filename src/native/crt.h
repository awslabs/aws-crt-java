...
/*******************************************************************************
 * aws_jni_acquire_thread_env - Acquires the reader lock on the set of valid JVMs and
 * the JNIEnv for the current thread from the VM, attaching the env if necessary.
