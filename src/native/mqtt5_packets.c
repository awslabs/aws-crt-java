    ...
    if (jni_user_properties_list) {
        for (size_t i = 0; i < java_packet_native_user_property_count; i++) {
            ...
            if (!jni_property || aws_jni_check_and_clear_exception(env)) {
                AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "Could not populate user properties due to being unable to get property in list from Java");
                aws_jni_throw_runtime_exception(env, "Could not populate user properties due to being unable to get property in list from Java");
            ...
            if (aws_jni_check_and_clear_exception(env)) {
                AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "Could not populate user properties due to exception when getting property key");
                aws_jni_throw_runtime_exception(env, "Could not populate user properties due to exception when getting property key");
            ...
            if (aws_jni_check_and_clear_exception(env)) {
                AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "Could not populate user properties due to exception when getting property value");
                aws_jni_throw_runtime_exception(env, "Could not populate user properties due to exception when getting property value");
                return aws_raise_error(AWS_ERROR_INVALID_STATE);
            }
...
struct aws_mqtt5_packet_connect_view_java_jni *aws_mqtt5_packet_connect_view_create_from_java(
    ...
    if (java_packet == NULL) {
        ...
        aws_jni_throw_runtime_exception(env, "ConnectPacket create_from_java: Creating new ConnectPacket failed");
        return NULL;
    }
    ...
    if (aws_jni_check_and_clear_exception(env)) {
        ...
        aws_jni_throw_runtime_exception(env, "ConnectPacket create_from_java: Error getting will packet");
        goto on_error;
    }
    if (jni_will_packet) {
        ...
        if (java_packet->will_publish_packet == NULL) {
            AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "ConnectPacket create_from_java: Error creating will packet!");
            aws_jni_throw_runtime_exception(env, "ConnectPacket create_from_java: Error creating will packet!");
            goto on_error;
        }
...
struct aws_mqtt5_packet_disconnect_view_java_jni *aws_mqtt5_packet_disconnect_view_create_from_java(
    ...
    if (java_packet == NULL) {
        ...
        aws_jni_throw_runtime_exception(env, "DisconnectPacket create_from_java: Creating new DisconnectPacket failed");
        return NULL;
    }
...
struct aws_mqtt5_packet_publish_view_java_jni *aws_mqtt5_packet_publish_view_create_from_java(
    ...
    if (java_packet == NULL) {
        ...
        aws_jni_throw_runtime_exception(env, "PublishPacket create_from_java: Creating new PublishPacket failed");
        return NULL;
    }
    ...
    if (s_get_qos_from_packet(
        ...
        aws_jni_throw_runtime_exception(env, "PublishPacket create_from_java: QOS not found");
        goto on_error;
    }
    ...
    if (aws_get_string_from_jobject(
        ...
        aws_jni_throw_runtime_exception(env, "PublishPacket create_from_java: No topic found");
        goto on_error;
    }
...
struct aws_mqtt5_packet_subscribe_view_java_jni *aws_mqtt5_packet_subscribe_view_create_from_java(
    ...
    if (!jni_subscriptions) {
        AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "SubscribePacket create_from_java: Creating new SubscribePacket failed due to no subscriptions!");
        aws_jni_throw_runtime_exception(env, "SubscribePacket create_from_java: Creating new SubscribePacket failed due to no subscriptions!");
        return NULL;
    }
    ...
    if (subscriptions_filter_size <= 0) {
        ...
        aws_jni_throw_runtime_exception(env, "SubscribePacket create_from_java: subscriptions count is 0");
        return NULL;
    }
    ...
    if (java_packet == NULL) {
        ...
        aws_jni_throw_runtime_exception(env, "SubscribePacket create_from_java: Creating new SubscribePacket failed");
        return NULL;
    }
    ...
    for (size_t i = 0; i < subscriptions_filter_size; i++) {
        ...
        if (aws_jni_check_and_clear_exception(env)) {
            ...
            aws_jni_throw_runtime_exception(env, "SubscribePacket create_from_java: Error getting topic filters");
            goto on_error;
        }
        ...
        if (aws_jni_check_and_clear_exception(env)) {
            AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "SubscribePacket create_from_java: Error getting subscription topic filter");
            aws_jni_throw_runtime_exception(env, "SubscribePacket create_from_java: Error getting subscription topic filter");
            goto on_error;
        }
        if (jni_topic_filter) {
            ...
            AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "SubscribePacket create_from_java: subscription topic filter is required");
            aws_jni_throw_runtime_exception(env, "SubscribePacket create_from_java: subscription topic filter is required");
            goto on_error;
        }
        ...
        if (s_get_qos_from_packet(
            ...
            aws_jni_throw_runtime_exception(env, "SubscribePacket create_from_java: subscription QoS is required");
            goto on_error;
        }
...
struct aws_mqtt5_packet_unsubscribe_view_java_jni *aws_mqtt5_packet_unsubscribe_view_create_from_java(
    ...
    if (!jni_topic_filters) {
        AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "UnsubscribePacket create_from_java: Creating new UnsubscribePacket failed due to no topic filters");
        aws_jni_throw_runtime_exception(env, "UnsubscribePacket create_from_java: Creating new UnsubscribePacket failed due to no topic filters");
        return NULL;
    }
    ...
    if (aws_jni_check_and_clear_exception(env)) {
        AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "UnsubscribePacket create_from_java: Created new UnsubscribePacket failed due to no topic filters");
        aws_jni_throw_runtime_exception(env, "UnsubscribePacket create_from_java: Created new UnsubscribePacket failed due to no topic filters");
        return NULL;
    }
    ...
    if (jni_topic_filter_size_check < 0) {
        ...
        aws_jni_throw_runtime_exception(env, "UnsubscribePacket create_from_java: No topic filters found");
        return NULL;
    } else {
    ...
    if (java_packet == NULL) {
        ...
        aws_jni_throw_runtime_exception(env, "UnsubscribePacket create_from_java: Creating new UnsubscribePacket failed");
        return NULL;
    }
    int array_init = aws_array_list_init_dynamic(
    ...
    for (size_t i = 0; i < topic_filter_size; i++) {
        ...
        if (aws_jni_check_and_clear_exception(env)) {
            AWS_LOGF_ERROR(AWS_LS_MQTT_CLIENT, "UnsubscribePacket create_from_java: Error getting subscription topic filter");
            aws_jni_throw_runtime_exception(env, "UnsubscribePacket create_from_java: Error getting subscription topic filter");
            goto on_error;
        }
        if (jni_topic_filter) {
            holder.jni_string = jni_topic_filter;
