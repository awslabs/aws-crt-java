...
public class Http2RequestResponseTest extends HttpClientTestFixture {
    ...
    private HttpClientConnectionManager createHTTP2ConnectionPoolManager(URI uri) {
        try(EventLoopGroup eventLoopGroup = new EventLoopGroup(1);
            ...
            TlsContextOptions tlsContextOptions = TlsContextOptions.createDefaultClient().withAlpnList("h2;http/1.1");
    ...
    public TestHttpResponse getResponse(URI uri, HttpRequest request, byte[] chunkedData) throws Exception {
        ...
        try (HttpClientConnectionManager connPool = createHTTP2ConnectionPoolManager(uri)) {
