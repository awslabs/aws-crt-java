...
public class Mqtt5ClientTest extends Mqtt5ClientTestFixture {
    ...
    public void ConnDC_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
    ...
    public void ConnDC_UC2() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_UC2Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnDC_UC3() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_UC3Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnDC_UC4() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_UC4Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnDC_UC5() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_UC5Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doConnDC_UC6Test() {
        try (EventLoopGroup elg = new EventLoopGroup(1);
            ...
            builder.withBootstrap(bootstrap)
                    ...
                    .withSessionBehavior(ClientSessionBehavior.CLEAN)
                    .withSocketOptions(socketOptions);
            // Skip websocket, proxy options, and TLS options - those are all different
            // tests
    ...
    public void ConnDC_UC6() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_UC6Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnWS_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnWS_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnWS_UC2() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnWS_UC2Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnWS_UC3() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnWS_UC3Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnWS_UC5() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnWS_UC5Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnWS_UC6() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnWS_UC6Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
        ...
        try {
            ...
            try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                ...
                if (foundExpectedError == false) {
                    System.out.println(
                            "Error code was not AWS_IO_DNS_INVALID_NAME like expected! There was an exception though");
                }
    ...
    public void ConnNegativeID_UC2() {
        ...
        try {
            ...
            try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                ...
                if (foundExpectedError == false) {
                    System.out.println(
                            "Error code was not AWS_IO_SOCKET_CONNECTION_REFUSED like expected! There was an exception though");
                }
                if (exceptionOccurred == false) {
                    fail("No exception occurred!");
                }
    ...
    public void ConnNegativeID_UC2_ALT() {
        ...
        try {
            ...
            try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                ...
                if (foundExpectedError == false) {
                    System.out.println(
                            "Error code was not AWS_ERROR_MQTT5_DECODE_PROTOCOL_ERROR like expected! There was an exception though");
                }
                if (exceptionOccurred == false) {
                    fail("No exception occurred!");
                }
        ...
        try {
            ...
            try (
                ...
                try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                    ...
                    if (foundExpectedError == false) {
                        System.out.println(
                                "Error code was not AWS_ERROR_SYS_CALL_FAILURE (occurs right after AWS_ERROR_MQTT5_DECODE_PROTOCOL_ERROR for Websockets) like expected! There was an exception though");
                    }
                    if (exceptionOccurred == false) {
                        fail("No exception occurred!");
                    }
        ...
        try {
            ...
            try (
                ...
                try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                    ...
                    if (foundExpectedError == false) {
                        System.out.println(
                                "Error code was not AWS_IO_SOCKET_TIMEOUT like expected! There was an exception though");
                    }
                    if (exceptionOccurred == false) {
                        fail("No exception occurred!");
                    }
        ...
        try {
            ...
            try (
                ...
                try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                    ...
                    if (foundExpectedError == false) {
                        System.out.println(
                                "Error code was not AWS_ERROR_UNKNOWN like expected! There was an exception though");
                    }
                    if (exceptionOccurred == false) {
                        fail("No exception occurred!");
                    }
    ...
    static final class LifecycleEvents_DoubleClientID implements Mqtt5ClientOptions.LifecycleEvents {
        ...
        public void onConnectionFailure(Mqtt5Client client, OnConnectionFailureReturn onConnectionFailureReturn) {
            // failing the connected future here is not valid from a race condition
            // standpoint. It is possible that
            // the interrupting client itself gets interrupted and fails to fully connect
            // due to the original client
            // interrupting it. Eventually it will succeed (briefly) as the two clients
            // fight over the client id
    ...
    private void doConnNegativeID_UC7Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            ConnectPacketBuilder connectOptions = new ConnectPacketBuilder()
                    .withClientId("test/MQTT5_Java_Double_ClientIDFail_" + testUUID);
            ...
            try (Mqtt5Client clientOne = new Mqtt5Client(builder.build());
                ...
                // Stop the clients from disconnecting each other. If we do not do this, then
                // the clients will
    ...
    public void ConnNegativeID_UC7() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnNegativeID_UC7Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void NewNegative_UC2() throws Exception {
        ...
        TestUtils.doRetryableTest(() -> {
            this.doNewNegative_UC2Test(disconnectBuilder);
    ...
    public void NewNegative_UC3() throws Exception {
        ...
        TestUtils.doRetryableTest(() -> {
            this.doNewNegative_UC3Test(publishBuilder);
        }, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES, TEST_RETRY_SLEEP_MILLIS);
    ...
    public void NewNegative_UC3_ALT() throws Exception {
        ...
        PublishPacketBuilder publishBuilder = new PublishPacketBuilder("test/topic", QOS.AT_LEAST_ONCE,
                "Hello World".getBytes());
    ...
    public void NewNegative_UC4() throws Exception {
        ...
        TestUtils.doRetryableTest(() -> {
            this.doNewNegative_UC4Test(subscribeBuilder);
        }, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES, TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doNegotiated_UC1Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                ...
                // assertEquals(
                // "Negotiated Settings session expiry interval does not match sent session
                // expiry interval",
    ...
    public void Negotiated_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doNegotiated_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void Negotiated_UC2() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doNegotiated_UC2Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void Negotiated_Rejoin_Always() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doNegotiated_Rejoin_AlwaysTest, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doOp_UC1Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            PublishPacketBuilder publishPacketBuilder = new PublishPacketBuilder(testTopic, QOS.AT_LEAST_ONCE,
                    "Hello World".getBytes());
    ...
    public void Op_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doOp_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doOp_UC2Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            ConnectPacketBuilder connectOptions = new ConnectPacketBuilder();
            PublishPacketBuilder willPacket = new PublishPacketBuilder(testTopic, QOS.AT_LEAST_ONCE,
                    "Hello World".getBytes());
    ...
    public void Op_UC2() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doOp_UC2Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void Op_UC3() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doOp_UC3Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doOp_UC4Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            try (Mqtt5Client publisher = new Mqtt5Client(builder.build());
                ...
                // Paranoid about service-side eventual consistency. Add a wait to reduce
                // chances of a missed will publish.
                TestUtils.sleepForAtLeastMilliseconds(2000);
    ...
    public void Op_UC4() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doOp_UC4Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doOp_SharedSubscriptionTest() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            // Publisher builder
            Mqtt5ClientOptionsBuilder publisherBuilder = new Mqtt5ClientOptionsBuilder(AWS_TEST_MQTT5_IOT_CORE_HOST,
                    8883l);
            ...
            Mqtt5ClientOptionsBuilder subscriberOneBuilder = new Mqtt5ClientOptionsBuilder(AWS_TEST_MQTT5_IOT_CORE_HOST,
                    8883l);
            ...
            Mqtt5ClientOptionsBuilder subscriberTwoBuilder = new Mqtt5ClientOptionsBuilder(AWS_TEST_MQTT5_IOT_CORE_HOST,
                    8883l);
            ...
            SubscribePacketBuilder subscribePacketBuilder = new SubscribePacketBuilder(sharedTopicfilter,
                    QOS.AT_LEAST_ONCE);
            ...
            try (Mqtt5Client publisherClient = new Mqtt5Client(publisherBuilder.build());
                ...
                subscriberOneClient.subscribe(subscribePacketBuilder.build()).get(OPERATION_TIMEOUT_TIME,
                        TimeUnit.SECONDS);
                subscriberTwoClient.subscribe(subscribePacketBuilder.build()).get(OPERATION_TIMEOUT_TIME,
                        TimeUnit.SECONDS);
                ...
                // Wait a little longer just to ensure that no packets beyond expectations are
                // arrived.
    ...
    public void Op_SharedSubscription() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doOp_SharedSubscriptionTest, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void Op_DirectPacketBuilders() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doOp_DirectPacketBuilders, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ErrorOp_UC1_ALT() throws Exception {
        ...
        TestUtils.doRetryableTest(() -> {
            this.doErrorOp_UC1Test(publish);
        }, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES, TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ErrorOp_UC2_ALT() throws Exception {
        ...
        TestUtils.doRetryableTest(() -> {
            this.doErrorOp_UC2Test(subscribe);
        }, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES, TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ErrorOp_UC3_ALT() throws Exception {
        ...
        TestUtils.doRetryableTest(() -> {
            this.doErrorOp_UC3Test(unsubscribe);
        }, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES, TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doQoS1_UC1Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            try (Mqtt5Client publisher = new Mqtt5Client(builder.build());
                ...
                SubscribePacketBuilder subscribePacketBuilder = new SubscribePacketBuilder(testTopic,
                        QOS.AT_LEAST_ONCE);
                subscriber.subscribe(subscribePacketBuilder.build()).get(OPERATION_TIMEOUT_TIME, TimeUnit.SECONDS);
    ...
    public void QoS1_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doQoS1_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doRetain_UC1Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            Mqtt5ClientOptionsBuilder publisherEventsBuilder = new Mqtt5ClientOptionsBuilder(
                    AWS_TEST_MQTT5_IOT_CORE_HOST, 8883l);
            ...
            Mqtt5ClientOptionsBuilder successSubscriberBuilder = new Mqtt5ClientOptionsBuilder(
                    AWS_TEST_MQTT5_IOT_CORE_HOST, 8883l);
            ...
            Mqtt5ClientOptionsBuilder unsuccessSubscriberBuilder = new Mqtt5ClientOptionsBuilder(
                    AWS_TEST_MQTT5_IOT_CORE_HOST, 8883l);
            ...
            try (Mqtt5Client publisher = new Mqtt5Client(publisherEventsBuilder.build());
                ...
                subscribePacketBuilder.withSubscription(testTopic, QOS.AT_LEAST_ONCE, false, true,
                        RetainHandlingType.SEND_ON_SUBSCRIBE);
                try {
                    successSubscriber.subscribe(subscribePacketBuilder.build()).get(OPERATION_TIMEOUT_TIME,
                            TimeUnit.SECONDS);
                } catch (Exception ex) {
                    // Clear the retained message
                    publisher.publish(publishPacketBuilder.build()).get(OPERATION_TIMEOUT_TIME, TimeUnit.SECONDS);
                ...
                unsuccessfulSubscriber.subscribe(subscribePacketBuilder.build()).get(OPERATION_TIMEOUT_TIME,
                        TimeUnit.SECONDS);
    ...
    public void Retain_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doRetain_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void Interrupt_Sub_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doInterrupt_Sub_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doInterrupt_Unsub_UC1Test() {
        try (TlsContextOptions tlsOptions = TlsContextOptions.createWithMtlsFromPath(
            ...
            try (Mqtt5Client client = new Mqtt5Client(builder.build())) {
                ...
                try {
                    CompletableFuture<UnsubAckPacket> unsubscribeResult = client
                            .unsubscribe(unsubscribePacketBuilder.build());
                    client.stop();
    ...
    public void Interrupt_Unsub_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doInterrupt_Unsub_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void Interrupt_Publish_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doInterrupt_Publish_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void OperationStatistics_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doOperationStatistics_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doConnDC_Cred_UC1Test() {
        try {
            java.security.KeyStore keyStore = java.security.KeyStore
                    .getInstance(AWS_TEST_MQTT5_IOT_CORE_KEYSTORE_FORMAT);
    ...
    public void ConnDC_Cred_UC1() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_Cred_UC1Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnDC_Cred_UC2() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_Cred_UC2Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    public void ConnDC_Cred_UC3() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_Cred_UC3Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doConnDC_Cred_UC4Test() {
        // The published Softhsm package on muslc (Alpine) crashes if we don't call
        // C_Finalize at the end.
        try (Pkcs11Lib pkcs11Lib = new Pkcs11Lib(AWS_TEST_MQTT5_IOT_CORE_PKCS11_LIB,
                Pkcs11Lib.InitializeFinalizeBehavior.STRICT);
    ...
    public void ConnDC_Cred_UC4() throws Exception {
        ...
        TestUtils.doRetryableTest(this::doConnDC_Cred_UC4Test, TestUtils::isRetryableTimeout, MAX_TEST_RETRIES,
                TEST_RETRY_SLEEP_MILLIS);
    ...
    private void doWebsocketIotCoreConnectionTest(Function<ClientBootstrap, CredentialsProvider> providerBuilder) {
        try (EventLoopGroup elg = new EventLoopGroup(1);
                ...
                Mqtt5ClientTestSigv4HandshakeTransformer transformer = new Mqtt5ClientTestSigv4HandshakeTransformer(
                        signingConfig);
        ...
        TestUtils.doRetryableTest(() -> {
            this.doWebsocketIotCoreConnectionTest(
                    (bootstrap) -> {
                        ...
                        credentialsBuilder
                                .withSecretAccessKey(AWS_TEST_MQTT5_ROLE_CREDENTIAL_SECRET_ACCESS_KEY.getBytes());
