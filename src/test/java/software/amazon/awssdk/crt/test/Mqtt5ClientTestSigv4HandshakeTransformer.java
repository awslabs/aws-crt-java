 ...
 */
public class Mqtt5ClientTestSigv4HandshakeTransformer extends CrtResource implements Consumer<Mqtt5WebsocketHandshakeTransformArgs> {
    AwsSigningConfig signingConfig;

    public Mqtt5ClientTestSigv4HandshakeTransformer(AwsSigningConfig signingConfig) {
